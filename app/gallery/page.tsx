...
export const metadata: Metadata = buildMetadata({
  title: "Gallery",
  description:
    "Explore Bala's Spring View by Vista Hills through our rooms, mountain views and unforgettable experiences.",
  path: "/gallery",
  image: "/images/about/exterior.jpg",
});

// This page's category list extends the homepage gallery's filters with
// "Night View" — kept local to this page so the homepage's own filter
    ...
    <main>
      ...
      <section className="bg-[#0E141B] px-6 py-24 sm:px-10 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <GalleryMasonryGrid images={galleryContent.images} filters={galleryPageFilters} />
        </div>
      </section>
      ...
      <section className="relative overflow-hidden bg-[#0F1720] px-6 py-24 text-center sm:px-10 sm:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          <h2 className="font-display text-3xl font-light leading-tight text-[#F8F8F5] sm:text-4xl">
            Ready to Experience Bala&apos;s Spring View?
          </h2>
          <div className="mt-9">
            <Link
              href="/book-now"
