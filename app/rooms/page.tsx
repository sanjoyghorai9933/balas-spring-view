...
export default function RoomsPage() {
  return (
    <main>
      ...
      {/* 2. Featured Rooms — reuses existing RoomCard via RoomsListingSection */}
      <RoomsListingSection />

      {/* 3. Room Comparison Table */}
      <CompareRoomsSection />

      {/* 4. Room Amenities — luxury icon grid */}
      <IncludedAmenities />
      ...
      <section className="relative overflow-hidden bg-[#0F1720] px-6 py-24 text-center sm:px-10 sm:py-28">
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          ...
          <p className="mt-4 font-body text-sm font-light leading-relaxed text-[#F8F8F5]/65 sm:text-base">
            Reserve your room at Bala&apos;s Spring View and wake up to the hills of Mussoorie.
          </p>
          <div className="mt-9">
            <Link
              href="/book-now"
